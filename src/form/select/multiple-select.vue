...
export default {
  ...
  props: {
    ...
    emptyLabel: {
      type: String,
      default: 'Cette liste est vide.'
    },
    nofoundLabel: {
      type: String,
      default: 'Aucun élèment trouvé.'
    }
  },
  data() {
    return {
...
.multiselect__tags {
  ...
  background-color: var(--select-tag-background, #148da0);
  min-height: 2rem;
}
...
.multiselect__tag-icon:focus, .multiselect__tag-icon:hover {
  background-color: var(--select-tag-hover, #0ba5bd);
...
.multiselect__select {
  ...
  align-items: center;
  background-color: var(--select-arrow-background, #148da0);
...
.multiselect__option.multiselect__option--highlight {
  background-color: var(--select-hover-background, #0ba5bd);
...
.multiselect__option--selected {
  font-weight: 600;
  background-color: var(--select-selected-background, #148da0);
...
.multiple-select.has-label label {
  position: absolute;
  font-size: 10px;
  color: var(--select-label-avtive-color, #148da0);
  font-weight: normal;
  pointer-events: none;
  top: -16px;
  white-space: nowrap;
...
.multiple-select {
  border-color: var(--select-label-border-color, #148da0);
  border-style: solid;
